...
firmware_mini_proto\sha_variant_O0.exe:     file format pei-x86-64
...
0000000140001075 <__tmainCRTStartup>:
   ...
   140001361:	e8 26 04 00 00       	call   14000178c <main>
...
0000000140001728 <simple_hash>:
   ...
   140001734:	c7 45 fc 01 ef cd ab 	mov    DWORD PTR [rbp-0x4],0xabcdef01
   14000173b:	c7 45 f8 00 00 00 00 	mov    DWORD PTR [rbp-0x8],0x0
   140001742:	eb 2b                	jmp    14000176f <simple_hash+0x47>
   140001744:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
   140001747:	ba 03 00 00 00       	mov    edx,0x3
   14000174c:	89 c1                	mov    ecx,eax
   14000174e:	e8 bd ff ff ff       	call   140001710 <rotate_right>
   140001753:	8b 55 f8             	mov    edx,DWORD PTR [rbp-0x8]
   140001756:	48 63 ca             	movsxd rcx,edx
   140001759:	48 8b 55 10          	mov    rdx,QWORD PTR [rbp+0x10]
   14000175d:	48 01 ca             	add    rdx,rcx
   140001760:	0f b6 12             	movzx  edx,BYTE PTR [rdx]
   140001763:	0f be d2             	movsx  edx,dl
   140001766:	31 d0                	xor    eax,edx
   140001768:	89 45 fc             	mov    DWORD PTR [rbp-0x4],eax
   14000176b:	83 45 f8 01          	add    DWORD PTR [rbp-0x8],0x1
   14000176f:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
   140001772:	48 63 d0             	movsxd rdx,eax
   140001775:	48 8b 45 10          	mov    rax,QWORD PTR [rbp+0x10]
   140001779:	48 01 d0             	add    rax,rdx
   14000177c:	0f b6 00             	movzx  eax,BYTE PTR [rax]
   14000177f:	84 c0                	test   al,al
   140001781:	75 c1                	jne    140001744 <simple_hash+0x1c>
   140001783:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
   140001786:	48 83 c4 30          	add    rsp,0x30
   14000178a:	5d                   	pop    rbp
   14000178b:	c3                   	ret

000000014000178c <main>:
   14000178c:	55                   	push   rbp
   14000178d:	48 89 e5             	mov    rbp,rsp
   140001790:	48 83 ec 30          	sub    rsp,0x30
   140001794:	e8 ee 00 00 00       	call   140001887 <__main>
   140001799:	48 8d 05 b0 98 00 00 	lea    rax,[rip+0x98b0]        # 14000b050 <.rdata>
   1400017a0:	48 89 45 f8          	mov    QWORD PTR [rbp-0x8],rax
   1400017a4:	48 8b 45 f8          	mov    rax,QWORD PTR [rbp-0x8]
   1400017a8:	48 89 c1             	mov    rcx,rax
   1400017ab:	e8 78 ff ff ff       	call   140001728 <simple_hash>
   1400017b0:	89 c2                	mov    edx,eax
   1400017b2:	48 8d 05 a3 98 00 00 	lea    rax,[rip+0x98a3]        # 14000b05c <.rdata+0xc>
   1400017b9:	48 89 c1             	mov    rcx,rax
   1400017bc:	e8 df 16 00 00       	call   140002ea0 <__mingw_printf>
   1400017c1:	b8 00 00 00 00       	mov    eax,0x0
   1400017c6:	48 83 c4 30          	add    rsp,0x30
