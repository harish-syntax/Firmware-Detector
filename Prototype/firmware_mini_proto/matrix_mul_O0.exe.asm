...
firmware_mini_proto\matrix_mul_O0.exe:     file format pei-x86-64
...
0000000140001710 <main>:
   ...
   140001714:	48 83 ec 70          	sub    rsp,0x70
   140001718:	e8 da 01 00 00       	call   1400018f7 <__main>
   14000171d:	c7 45 e0 01 00 00 00 	mov    DWORD PTR [rbp-0x20],0x1
   140001724:	c7 45 e4 02 00 00 00 	mov    DWORD PTR [rbp-0x1c],0x2
   14000172b:	c7 45 e8 03 00 00 00 	mov    DWORD PTR [rbp-0x18],0x3
   140001732:	c7 45 ec 04 00 00 00 	mov    DWORD PTR [rbp-0x14],0x4
   140001739:	c7 45 d0 05 00 00 00 	mov    DWORD PTR [rbp-0x30],0x5
   140001740:	c7 45 d4 06 00 00 00 	mov    DWORD PTR [rbp-0x2c],0x6
   140001747:	c7 45 d8 07 00 00 00 	mov    DWORD PTR [rbp-0x28],0x7
   14000174e:	c7 45 dc 08 00 00 00 	mov    DWORD PTR [rbp-0x24],0x8
   140001755:	c7 45 fc 00 00 00 00 	mov    DWORD PTR [rbp-0x4],0x0
   14000175c:	e9 a5 00 00 00       	jmp    140001806 <main+0xf6>
   140001761:	c7 45 f8 00 00 00 00 	mov    DWORD PTR [rbp-0x8],0x0
   140001768:	e9 8b 00 00 00       	jmp    1400017f8 <main+0xe8>
   14000176d:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
   140001770:	48 98                	cdqe
   140001772:	8b 55 fc             	mov    edx,DWORD PTR [rbp-0x4]
   140001775:	48 63 d2             	movsxd rdx,edx
   140001778:	48 01 d2             	add    rdx,rdx
   14000177b:	48 01 d0             	add    rax,rdx
   14000177e:	c7 44 85 c0 00 00 00 	mov    DWORD PTR [rbp+rax*4-0x40],0x0
   140001785:	00 
   140001786:	c7 45 f4 00 00 00 00 	mov    DWORD PTR [rbp-0xc],0x0
   14000178d:	eb 5f                	jmp    1400017ee <main+0xde>
   14000178f:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
   140001792:	48 98                	cdqe
   140001794:	8b 55 fc             	mov    edx,DWORD PTR [rbp-0x4]
   140001797:	48 63 d2             	movsxd rdx,edx
   14000179a:	48 01 d2             	add    rdx,rdx
   14000179d:	48 01 d0             	add    rax,rdx
   1400017a0:	8b 4c 85 c0          	mov    ecx,DWORD PTR [rbp+rax*4-0x40]
   1400017a4:	8b 45 f4             	mov    eax,DWORD PTR [rbp-0xc]
   1400017a7:	48 98                	cdqe
   1400017a9:	8b 55 fc             	mov    edx,DWORD PTR [rbp-0x4]
   1400017ac:	48 63 d2             	movsxd rdx,edx
   1400017af:	48 01 d2             	add    rdx,rdx
   1400017b2:	48 01 d0             	add    rax,rdx
   1400017b5:	8b 54 85 e0          	mov    edx,DWORD PTR [rbp+rax*4-0x20]
   1400017b9:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
   1400017bc:	48 98                	cdqe
   1400017be:	44 8b 45 f4          	mov    r8d,DWORD PTR [rbp-0xc]
   1400017c2:	4d 63 c0             	movsxd r8,r8d
   1400017c5:	4d 01 c0             	add    r8,r8
   1400017c8:	4c 01 c0             	add    rax,r8
   1400017cb:	8b 44 85 d0          	mov    eax,DWORD PTR [rbp+rax*4-0x30]
   1400017cf:	0f af c2             	imul   eax,edx
   1400017d2:	8d 14 01             	lea    edx,[rcx+rax*1]
   1400017d5:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
   1400017d8:	48 98                	cdqe
   1400017da:	8b 4d fc             	mov    ecx,DWORD PTR [rbp-0x4]
   1400017dd:	48 63 c9             	movsxd rcx,ecx
   1400017e0:	48 01 c9             	add    rcx,rcx
   1400017e3:	48 01 c8             	add    rax,rcx
   1400017e6:	89 54 85 c0          	mov    DWORD PTR [rbp+rax*4-0x40],edx
   1400017ea:	83 45 f4 01          	add    DWORD PTR [rbp-0xc],0x1
   1400017ee:	83 7d f4 01          	cmp    DWORD PTR [rbp-0xc],0x1
   1400017f2:	7e 9b                	jle    14000178f <main+0x7f>
   1400017f4:	83 45 f8 01          	add    DWORD PTR [rbp-0x8],0x1
   1400017f8:	83 7d f8 01          	cmp    DWORD PTR [rbp-0x8],0x1
   1400017fc:	0f 8e 6b ff ff ff    	jle    14000176d <main+0x5d>
   140001802:	83 45 fc 01          	add    DWORD PTR [rbp-0x4],0x1
   140001806:	83 7d fc 01          	cmp    DWORD PTR [rbp-0x4],0x1
   14000180a:	0f 8e 51 ff ff ff    	jle    140001761 <main+0x51>
   140001810:	8b 55 cc             	mov    edx,DWORD PTR [rbp-0x34]
   140001813:	44 8b 4d c8          	mov    r9d,DWORD PTR [rbp-0x38]
   140001817:	44 8b 45 c4          	mov    r8d,DWORD PTR [rbp-0x3c]
   14000181b:	8b 45 c0             	mov    eax,DWORD PTR [rbp-0x40]
   14000181e:	48 8d 0d 2b 98 00 00 	lea    rcx,[rip+0x982b]        # 14000b050 <.rdata>
   140001825:	89 54 24 20          	mov    DWORD PTR [rsp+0x20],edx
   140001829:	89 c2                	mov    edx,eax
   14000182b:	e8 e0 16 00 00       	call   140002f10 <__mingw_printf>
   140001830:	b8 00 00 00 00       	mov    eax,0x0
   140001835:	48 83 c4 70          	add    rsp,0x70
   140001839:	5d                   	pop    rbp
   14000183a:	c3                   	ret
   14000183b:	90                   	nop
   14000183c:	90                   	nop
   14000183d:	90                   	nop
